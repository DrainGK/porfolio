...
Command: npx gltfjsx@6.2.3 public/objects/mic.glb
...
export function Mic(props) {
    const group = useRef();
    const { nodes, materials } = useGLTF('objects/mic.glb')
    return (
        <group {...props} ref={group} dispose={null} rotation-y={Math.PI / 2} rotation-x={Math.PI / 2}>
